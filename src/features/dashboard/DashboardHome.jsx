import { FiActivity, FiDroplet, FiWind, FiThermometer, FiWifi, FiWifiOff } from 'react-icons/fi'
...
export default function DashboardHome() {
  ...
  if (loading) return <LoadingSpinner message="Cargando datos ambientales..." />;
    ...
    <div className="min-h-screen p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6">
        ...
        <SensorCard
          ...
          unit="°C"
          icon={<FiThermometer className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-500" />}
        ...
        <SensorCard
          ...
          unit="%"
          icon={<FiDroplet className="w-4 h-4 sm:w-5 sm:h-5 text-blue-500" />}
          location="Sala Principal"
          type="humidity"
          statusFn={getSensorStatus}
          getStatusColorFn={getStatusColor}
        ...
        <SensorCard
          ...
          unit="ppm"
          icon={<FiWind className="w-4 h-4 sm:w-5 sm:h-5 text-amber-500" />}
          location="Sala Principal"
          type="co2"
          statusFn={getSensorStatus}
          getStatusColorFn={getStatusColor}
        ...
        <SensorCard
          ...
          unit="hPa"
          icon={<FiActivity className="w-4 h-4 sm:w-5 sm:h-5 text-purple-500" />}
          location="Sala Principal"
          type="pressure"
          statusFn={getSensorStatus}
          getStatusColorFn={getStatusColor}
